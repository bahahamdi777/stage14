            ...
            <!-- <div >
              ...
              <div class="row mt-3">
                  <div class="col">
                      ...
                      <input type="text" id="locid" name="local" placeholder="saisir..." class="form-control form-control-sm"  value="<?php echo $commande['localite']; ?>" required>
                  </div>
                  <div class="col">
                      <label for="adressid" class="form-label">ADRESSE COMPLEMENTAIRE</label>
                      <input type="text" id="adressid" name="adresse"  class="form-control form-control-sm" value="<?php echo $commande['adresse_complementaire']; ?>"  required>
                  </div>
              </div>
              ...
              <div class="row mt-3">
                ...
                <div class="col ">
                    <div class="form-group">
                        ...
                        <input type="text"  name="telephone" class="form-control form-control-sm phone-input" id="phoneNumber" placeholder="nn nnn nnn" pattern="\d{2} \d{3} \d{3}"  value="<?php echo $commande['telephone']; ?>" required>
                    </div>
                </div>
                ...
                <div class="col ">
                    <div class="form-group">
                        ...
                        <input type="text"  name="telephone2" class="form-control form-control-sm phone-input" id="phoneNumber" placeholder="nn nnn nnn" pattern="\d{2} \d{3} \d{3}"  value="<?php echo $commande['telephone2']; ?>">
                    </div>
                </div>
            </div>
              <div class="row mt-3">
              ...
              <div class="row">
                  <div class="col-9">
                      <div class="mt-3">
                         ...
                         <textarea id="idcomments" name="comm" rows="4" cols="50" placeholder="veuillez saisir votre commentaire" class="form-control form-control-sm" value="<?php echo $commande['commentaire']; ?>"></textarea><br>
                         </div>
                  </div>
              </div>
